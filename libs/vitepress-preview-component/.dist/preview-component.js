import { openBlock as d, createElementBlock as p, createElementVNode as i, ref as v, defineComponent as Z, watch as V, createBlock as y, Transition as j, withCtx as x, normalizeClass as a, unref as n, normalizeStyle as q, createVNode as H, toDisplayString as b, createCommentVNode as M, createApp as G, computed as N, onMounted as F, resolveComponent as S, renderSlot as B } from "vue";
const T = (o, t) => {
...
const O = /* @__PURE__ */ T(J, [["render", X]]), Y = {}, ee = {
  t: "1661231449868",
  class: "icon",
  viewBox: "0 0 1024 1024",
  version: "1.1",
...
function oe(o, t) {
  return d(), p("svg", ee, ne);
}
const U = /* @__PURE__ */ T(Y, [["render", oe]]), se = {}, ce = {
  viewBox: "0 0 544 560",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, ie = /* @__PURE__ */ i("path", {
...
function re(o, t) {
  return d(), p("svg", ce, le);
}
const z = /* @__PURE__ */ T(se, [["render", re]]), k = "vitepress-demo-preview", $ = (o, t, e, c) => {
  let l = t === "" ? `${o}` : `${o}-${t}`;
...
function ve(o, t) {
  return d(), p("svg", de, pe);
}
const _e = /* @__PURE__ */ T(ae, [["render", ve]]), me = /* @__PURE__ */ Z({
  ...
  setup(o, { expose: t }) {
    ...
    return t({
      ...
      default: x(() => [
        l.value ? (d(), p("div", {
          key: 0,
          class: a([n(c).bem("message-notice", "container")]),
          style: q({ top: m.value + "px" })
        }, [
          H(_e),
          i("span", null, b(u.content), 1)
        ], 6)) : M("", !0)
      ]),
      _: 1
    }));
  ...
  open: () => {
    const o = document.createElement("div"), t = G(me, {
      content: "复制成功！",
      close: () => {
    ...
    e.setTopHeight(l), e.setVisible(!0), I.push(e);
  }
}, he = ["innerHTML"], Le = ["innerHTML"], He = /* @__PURE__ */ Z({
  __name: "AntDesign",
  props: {
    code: {},
    showCode: {},
  ...
  setup(o) {
    const t = o, e = A(), { isCodeFold: c, setCodeFold: l } = R(), { copyContent: _, clickCopy: m } = E(), h = v(decodeURIComponent(t.code)), C = v(decodeURIComponent(t.showCode)), u = v(null), L = () => {
      m(h.value), D.open();
    }, f = N(() => {
      var r;
    ...
    return F(() => {
      ...
      const w = S("ClientOnly");
      return d(), p("div", {
        class: a([n(e).e("ant-design__container")])
      }, [
        i("section", {
          class: a([n(e).bem("preview")])
        }, [
          H(w, null, {
            default: x(() => [
              B(r.$slots, "default")
        ...
        i("section", {
          class: a([n(e).bem("description")])
        }, [
          t.title ? (d(), p("div", {
            key: 0,
            class: a([n(e).bem("description", "title")])
          }, b(r.title), 3)) : M("", !0),
          t.description ? (d(), p("div", {
            key: 1,
            class: a([n(e).bem("description", "content")]),
            innerHTML: r.description
          }, null, 10, he)) : M("", !0),
          t.description || !t.title && !t.description ? (d(), p("div", {
            key: 2,
            class: a([n(e).bem("description", "split-line")])
          }, null, 2)) : M("", !0),
          i("div", {
            class: a([n(e).bem("description", "handle-btn")])
          }, [
            n(c) ? (d(), y(O, {
              key: 1,
              onClick: g[1] || (g[1] = (P) => n(l)(!1))
            })) : (d(), y(U, {
              key: 0,
              onClick: g[0] || (g[0] = (P) => n(l)(!0))
            })),
            H(z, { onClick: L })
          ], 2)
        ], 2),
        i("section", {
          class: a([n(e).bem("source")]),
  ...
  setup(o) {
    const t = o, e = A(), { isCodeFold: c, setCodeFold: l } = R(), { clickCopy: _ } = E(), m = v(decodeURIComponent(t.code)), h = v(decodeURIComponent(t.showCode)), C = v(null), u = () => {
      _(m.value), D.open();
    }, L = N(() => {
      var s;
    ...
    return F(() => {
      ...
      return d(), p("div", {
        class: a([n(e).e("element-plus__container")])
      }, [
        i("section", {
          class: a([n(e).bem("preview")])
        }, [
    ...
    return F(() => {
      ...
      return d(), p("div", {
        ...
        i("section", {
          ...
          t.title ? (d(), p("div", {
            key: 0,
            class: a([n(e).bem("component", "name")])
          }, b(s.title), 3)) : M("", !0),
          i("div", {
            class: a([n(e).bem("description", "btns")])
          }, [
            H(z, { onClick: u }),
            n(c) ? (d(), y(O, {
              key: 1,
