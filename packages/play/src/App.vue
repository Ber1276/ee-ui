...
<template>
  <div>
    <p>
      <er-button @click="handleBtnClick" :use-throttle="false">Default</er-button>
      <er-button type="primary" @click="handleNotify">Primary</er-button>
      <er-button type="success" @click="console.log('click')">Success</er-button>
  ...
  <er-tooltip ref="tooltipRef" placement="right-end" trigger="contextmenu"
  ...
  <er-switch v-model="switchValue" size="large" active-text="ON" inactive-text="OFF" />
  <er-select v-model="selectValue" placeholder="请选择" :render-label="customOptionRender" :options="selectOptions"
  ...
  <er-form ref="formRef" :model="formData" :rules="formRules" label-suffix=":" er-loading-text="loading..."
    er-loading-spinner="circle-notch" @submit="submit">
    ...
    <er-form-item label="confirm password" prop="confirmPwd" :rules="[
      {
        required: true,
        trigger: 'test',
        message: '测试自定义触发',
  ...
  <er-upload action="https://run.mocky.io/v3/9d059bf9-4660-45f2-925d-ce80ad6c4d15" :default-file-list="[
    {
      uid: '123',
      size: 123,
      name: 'test.png',
