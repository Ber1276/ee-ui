...
import { debugWarn } from "@ee-ui/utils";
import { useFocusController } from "@ee-ui/hooks";
  ...
  <div class="er-input" :class="{
    ...
    <template v-if="type !== 'textarea'">
      ...
      <div class="er-input__wrapper" ref="wrapperRef">
        ...
        <!-- suffix slot -->
        <span v-if="$slots.suffix || showClear || showPasswordArea" class="er-input__suffix">
          <slot name="suffix"></slot>
          <Icon icon="circle-xmark" v-if="showClear" class="er-input__clear" @click="clear" @mousedown.prevent="noop" />
          <Icon icon="eye" v-if="showPasswordArea && passwordVisible" class="er-input__password"
            @click="togglePasswordVisible" />
          <Icon icon="eye-slash" v-if="showPasswordArea && !passwordVisible" class="er-input__password"
            @click="togglePasswordVisible" />
        </span>
      </div>
      <!-- append slot -->
